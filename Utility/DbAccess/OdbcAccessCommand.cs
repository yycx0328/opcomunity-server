...
namespace Utility.DataAccess
{
    ...
    {
        #region TraceInfo
        static string TraceClass = typeof(OdbcAccessCommand).FullName;
        static bool IsTraced = Tracer.Instance.IsTraced(typeof(OdbcAccessCommand));
        #endregion
        ...
        public OdbcAccessCommand(string connectionString)
